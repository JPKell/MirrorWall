...
They do **not** define what a consumer installs. `pip install mirrorwall` resolves the compatible
...
prepared during M4 and held unpublished (`M4_HANDOFF.md`, entries WDB3, SS6, LCX23). PyPI carried
...
`src/mirrorwall`. A path-based source reports 0 % against a non-editable install — the tests all
