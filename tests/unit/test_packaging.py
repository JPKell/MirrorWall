...
dependencies MirrorWall is entitled to beyond the suite packages it imports; this reads the
...
# MirrorWall.
APPROVED_NON_SUITE_DEPENDENCIES: frozenset[str] = frozenset({"anyio", "jinja2", "starlette"})
