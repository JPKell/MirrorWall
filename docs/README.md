# MirrorWall — Local Documentation

**This is a curated copy**, not the source of truth. It was generated from the suite's central
`ai-suite-docs` repository so that `mirrorwall` can be read, reviewed and implemented **without**
...
- [development-plan.md](packages/mirrorwall/development-plan.md)
- [spec.md](packages/mirrorwall/spec.md)
